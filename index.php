...
if (!isset($_GET['echostr'])) {
	...
	function get_token() {
				...
				$appid="wxfd0900f98c4d5ba8";
				$secret="a9fe7a410107ca30843a3165575099f1";
        ...
        switch ($object->Event)
        {
            ...
            case "CLICK":
                switch ($object->EventKey)
                {
                    case "COMPANY":
                        $content = array();
                        $content[] = array("Title"=>"怡得保", "Description"=>"", "PicUrl"=>"http://discuz.comli.com/weixin/weather/icon/cartoon.jpg", "Url" =>"http://m.cnblogs.com/?u=txw1958");
                        break;
                    default:
