 ...
 * @Last Modified time: 2017-06-11 21:38:54
 */
var product_name;
var product_img;
var company_name;
...
function updatePremium() {
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
          ...
          //  document.getElementById("birthday_gift").innerHTML = zsj+"万";
...
function dateChange() {
    console.log(78988888)
    updatePremium();
}

function refreshURL(){
    var _url = 'aijiabei.htm?product_name='+product_name+'&img='+product_img+'&birthday='+birthday+'&gender='+gender+'&coverage='+coverage+'&period='+period+'&insurance_period='+insurance_period;
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            if (payments_arr[5] == "" || payments_arr[5] == "0") {
                ...
                $('#birthday_gift_age').html(payments_arr[5]);
            }
